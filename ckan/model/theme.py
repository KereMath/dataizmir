# ckan/model/theme.py
from sqlalchemy import Column, String, Text, DateTime, Integer, ForeignKey, Table, Float # Float eklendi
...
theme_category_table = Table(
    ...
    Column('opacity', Float, default=1.0), # Burası eklendi veya düzeltildi
