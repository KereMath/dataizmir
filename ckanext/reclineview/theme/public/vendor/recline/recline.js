    ...
    <div class="recline-flot"> \
      <div class="panel graph" style="display: block;"> \
        <div class="js-temp-notice alert alert-warning alert-block"> \
          <h3 class="alert-heading">Grafik Hazırla:</h3> \
          <p>Grafik gösterimi için tütfen <strong>sağ tarafta yer alan kutucuklarda</strong> veri seçimi yapınız.</p> \
        </div> \
      </div> \
    </div> \
',
  ...
  <div class="editor"> \
    <form class="form-stacked"> \
        ...
        <div class="form-group"> \
          ...
          <div class="input editor-type"> \
            <select class="form-control"> \
              <option value="lines-and-points">Çizgi ve Nokta</option> \
              <option value="lines">Çizgi</option> \
              <option value="points">Nokta</option> \
              <option value="bars">Çubuk</option> \
              <option value="columns">Sütun</option> \
            </select> \
          </div> \
        </div> \
        <div class="form-group"> \
      ...
      <div class="editor-buttons"> \
        <button class="btn btn-default editor-add">Veri ekle</button> \
      </div> \
...
',
  templateSeriesEditor: ' \
    <div class="editor-series js-series-{{seriesIndex}}"> \
      <div class="form-group"> \
        <label>Y-Ekseni (<span>{{seriesName}}</span>) \
          [<a href="#remove" class="action-remove-series">Kaldır</a>] \
        </label> \
        <div class="input"> \
          <select class="form-control"> \
          {{#fields}} \
...
',
  ...
  _setupMap: function(){
    ...
    var mapUrl = this.options.mapTilesURL || 'https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png';
...
my.MapMenu = Backbone.View.extend({
  ...
  template: ' \
    <form class="form-stacked"> \
      <div class="clearfix"> \
        <div class="editor-field-type"> \
            <label class="radio"> \
              ...
              Enlem/Boylam Sütunları</label> \
            <label class="radio"> \
              <input type="radio" id="editor-field-type-geom" name="editor-field-type" value="geom" /> \
              GeoJSON Sütunu</label> \
        </div> \
        <div class="editor-field-type-latlon"> \
		  <p style="color:blue; font-size:14px" align="justify"><b>Eğer veri içeriğinde coğrafi koordinat bilgisi içeren sütunlar bulunuyorsa, aşağıdaki Enlem & Boylam kutucuklarında bu sütunları seçerek mekânsal görselleştirme yapabilirsiniz!</b></p> \
          <label>Enlem Sütunu</label> \
        ...
        <div class="editor-field-type-geom" style="display:none"> \
          <label>Geometri Sütunu (GeoJSON)</label> \
      ...
      <div class="editor-buttons"> \
        <button class="btn btn-default editor-update-map">Göster</button> \
      </div> \
      <div class="editor-options" > \
        <label class="checkbox"> \
          <input type="checkbox" id="editor-auto-zoom" value="autozoom" checked="checked" /> \
          Objelere otomatik yaklaş</label> \
        <label class="checkbox"> \
          <input type="checkbox" id="editor-cluster" value="cluster"/> \
          Objeleri kümele</label> \
      </div> \
...
my.MultiView = Backbone.View.extend({
  ...
  <div class="navigation test">         <div class="btn-group" data-toggle="buttons-radio">              <button href="#graph" data-view="graph" class="btn btn-default graph1" aria-pressed="false">Grafik ekle</button>                                </div>       </div> \
    ...
    <div class="header clearfix"> \
      <div class="navigation"> \
        ...
        {{#views}} \
        <button href="#{{id}}" data-view="{{id}}" class="btn btn-default {{id}}">{{label}}</button> \
        {{/views}} \
        </div> \
      </div> \
      ...
      {{/recordCountWasEstimated}} \
      <span class="doc-count">{{recordCount}}</span> kayıt \
      </div> \
    ...
    <form action="" method="GET" class="form-inline" role="form"> \
      <div class="form-group"> \
        <div class="input-group text-query"> \
          ...
          <input class="form-control search-query" type="text" id="q" name="q" value="{{q}}" placeholder="Veri ara..."> \
        </div> \
      </div> \
      <button type="submit" class="btn btn-default">Git &raquo;</button> \
    </form> \
  ',
